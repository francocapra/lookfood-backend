...
public class DBService {
	...
	public void instatiateTestDataBase() throws Exception {
		...
		Product p1 = new Product(null, "Prato1", sdf.parse("30/09/2017 10:32"),null,null);
		Product p2 = new Product(null, "Prato2", sdf.parse("30/09/2017 10:32"),null,null);
		Product p3 = new Product(null, "Prato3", sdf.parse("30/09/2017 10:32"),null,null);
		Product p4 = new Product(null, "Prato4", sdf.parse("30/09/2017 10:32"),null,null);
		Product p5 = new Product(null, "Prato5", sdf.parse("30/09/2017 10:32"),null,null);
		Product p6 = new Product(null, "Prato6", sdf.parse("30/09/2017 10:32"),null,null);
		Product p7 = new Product(null, "Prato7", sdf.parse("30/09/2017 10:32"),null,null);
		Product p8 = new Product(null, "Prato8", sdf.parse("30/09/2017 10:32"),null,null);
		Product p9 = new Product(null, "Prato9", sdf.parse("30/09/2017 10:32"),null,null);
