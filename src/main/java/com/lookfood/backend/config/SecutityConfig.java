...
public class SecutityConfig extends WebSecurityConfigurerAdapter {
	...
	// Injeção da Interface: Spring Boot busca automaticamente a minha implementação
	// "UserSSService"
	@Autowired
	...
	public static final String[] PUBLIC_MATCHERS_GET = { "/products/**", "/professionals/**", "/regions/**" , "/reviews/token/**" };
	...
	// Para permitir acesso de multiplas-fontes(cross-origin) sejam feitas ao nosso
	// backend
